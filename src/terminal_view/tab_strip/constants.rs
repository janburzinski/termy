...
pub(crate) const VERTICAL_TITLEBAR_CONTROL_BUTTON_SIZE: f32 = 16.0;
pub(crate) const VERTICAL_TITLEBAR_CONTROL_BUTTON_COMPACT_SIZE: f32 = 14.0;
pub(crate) const VERTICAL_TITLEBAR_CONTROL_ICON_SIZE: f32 = 10.0;
pub(crate) const VERTICAL_TITLEBAR_CONTROL_ICON_COMPACT_SIZE: f32 = 9.0;
pub(crate) const VERTICAL_TITLEBAR_CONTROL_GAP: f32 = 6.0;
pub(crate) const VERTICAL_TITLEBAR_CONTROL_COMPACT_GAP: f32 = 4.0;
