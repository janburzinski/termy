...
function getPackageManagerButtonClass(
  ...
  const baseClassName = "px-2 py-1 rounded text-[11px] font-medium transition-colors";
    ...
    <section className="relative pt-28 pb-20">
      <div className="relative">
        ...
        <div className="text-center max-w-4xl mx-auto px-6">
          ...
          >
            Lightweight, GPU-rendered, and built with Rust.
            Termy starts instantly and stays fast.
          </p>
          ...
          >
            ...
            <div className="flex items-center gap-3 text-xs text-muted-foreground/50">
              <span className="flex items-center gap-1">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M22 17.607c-.786 2.28-3.139 6.317-5.563 6.361-1.608.031-2.125-.953-3.963-.953-1.837 0-2.412.923-3.932.983-2.572.099-6.542-5.827-6.542-10.995 0-4.747 3.308-7.1 6.198-7.143 1.55-.028 3.014 1.045 3.959 1.045.949 0 2.727-1.29 4.596-1.101.782.033 2.979.315 4.389 2.377-3.741 2.442-3.158 7.549.858 9.426zm-5.222-17.607c-2.826.114-5.132 3.079-4.81 5.531 2.612.203 5.118-2.725 4.81-5.531z"/></svg>
                macOS
              </span>
              <span className="flex items-center gap-1">
        ...
        >
          ...
          <p className="mt-3 text-center text-xs text-muted-foreground/50 animate-blur-in" style={{ animationDelay: "600ms" }}>
